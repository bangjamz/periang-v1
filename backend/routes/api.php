...
Route::post('/lupa-kata-sandi', [AuthController::class, 'lupaKataSandi']);
Route::post('/reset-kata-sandi', [AuthController::class, 'resetKataSandi']);
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::put('/profil/kata-sandi', [AuthController::class, 'gantiKataSandi']);
